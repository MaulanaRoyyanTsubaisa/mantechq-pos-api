...
<x-filament-panels::page>
    <h2 class="text-xl font-bold mb-4">All Bookings ({{ $bookings->count() }})</h2>    <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
                @forelse($bookings as $booking)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-200">{{ $booking->created_at->format('d M Y H:i') }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">No bookings found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
