...
<x-filament-panels::page>
    <h2 class="text-xl font-bold mb-4">Weekly Bookings ({{ $bookings->count() }})</h2>    <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">No bookings this week.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
